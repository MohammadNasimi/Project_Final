...
from order.views import OrderViewSets, Order_itemViewSets, Order_itemsDeleteView, card_list, Order_itemsUpdateView, \
    Order_items_sessionDeleteView ,Order_itemsUpdate_sessionView
...
urlpatterns = [
    ...
    path('update_order_item_session/<int:pk>', Order_itemsUpdate_sessionView.as_view(), name='update_order_item_session'),
